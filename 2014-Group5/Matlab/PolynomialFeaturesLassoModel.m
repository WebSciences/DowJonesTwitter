% We build the linear lasso regression model based on the features extracted from PPCA and polynomial feature map.
...
stockname = 'IBM'; % Change this to 'IBM', 'Intel' or 'GE'
...
%PolynomialFeatures = zscore(PolynomialFeatures);
%PolynomialFeatures = zscore(TwitterFeatures);
...
% Save results
save(strcat('Lasso_PolynomialFeatures_PredictionTable_', stockname, ''), 'PredictedTables', 'TwitterDaysUsed');
